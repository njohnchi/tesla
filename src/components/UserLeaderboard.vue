  ...
  <Card>
    ...
    <div class="container">
      <div class="banner-wrapper">
        <img class="profile-image" src="/p_1.png" alt="banner">
        <div class="content">
          <h3 class="topic-name">Food Safety</h3>
          <div class="status">
            <span class="correct-text">673 Points - 73% correct</span>
            <span>
              1
      ...
      <div class="banner-wrapper">
        <img class="profile-image" src="/p_2.png" alt="banner">
        <div class="content">
          <h3 class="topic-name">Food Safety</h3>
          <div class="status">
            <span class="correct-text">375 Points - 34% correct</span>
            <span>
              2
              <svg width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
